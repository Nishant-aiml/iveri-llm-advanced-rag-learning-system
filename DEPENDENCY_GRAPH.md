# 🔗 DEPENDENCY_GRAPH.md — IVERI LLM Module Dependency Map

This document outlines the dependencies, interfaces, critical paths, latency hotspots, and broken coupling across the IVERI LLM codebase.
