...
This document establishes the relationship between IVERI LLM's 14 top-level capabilities, their directory/file layout, and their assigned specialized subagents.

---

## 1. Top-Level Capabilities & File Mappings

Below is the mapping of IVERI's features to their corresponding backend modules, frontend files, and core engine files.
